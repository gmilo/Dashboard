...
export async function GET(request: Request) {
  ...
  const upstreamUrl = new URL(`${config.dataBaseUrl}/dashify-inventory-deducts.php`);
  ...
  return NextResponse.json(
    {
      ...
      filters_used: { date_from: dateFrom, date_to: dateTo, limit: Number(limit), company_id: companyIdRaw ? Number(companyIdRaw) : null },
      data: filtered
    },
